...
import KeywordFilterBelowComponent from './filter-above'
...
const ProductKeywordBelowComponent = ({isExtensionInstalled}) => {
  ...
  return (
    <>
      <KeywordFilterBelowComponent showFilter={showFilter} onClose={onHideFilter} />
...
export default ProductKeywordBelowComponent
